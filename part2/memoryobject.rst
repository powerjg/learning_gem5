...
This interface is made of function ``getPort``.
...
However, it will be an error if we try to connect a port to any other undefined port since the parent class has no ports defined.
